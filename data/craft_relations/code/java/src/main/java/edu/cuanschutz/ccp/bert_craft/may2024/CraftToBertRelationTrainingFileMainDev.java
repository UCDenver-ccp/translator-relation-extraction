	...
	public static void main(String[] args) {
		...
		try {
			...
			Set<String> relationsOfInterest = new HashSet<String>(Arrays.asList(
					...
					"bears_situatedness_or_possession_of", "occurrence_or_attribute_of_processing_or_bringing_about_of",
					...
					"occurrence_or_attribute_or_bearer_of_derivation_from", "region_of", "bearer_of_associativity_with",
					"has_variant_or_attribute_of_variation", "has_attribute_of_activity_or_its_realization_with",
					...
					"is_associated_with_or_situated_at_or_involves", "attribute_or_bearer_of_holding_within_of",
					...
					"occurrence_or_attribute_or_effect_of_loss_of", "absence_of",
					...
					"is_variant_sequence_bearing_derivational_relation_to_or_information_of", "deficiency_of",
					...
					"occurrence_or_attribute_of_release_of", "has_attribute_of_progression_or_its_realization_with",
