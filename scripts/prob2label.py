...
if model_key == 'bl_chemical_to_disease_or_phenotypic_feature':
    ...
    labels[2]="associated_with_resistance_to"
    labels[3]="associated_with_sensitivity_to"
    labels[4]="decreases_risk_for"
    labels[5]="exacerbates"
    labels[6]="exposure_is_origin_of"
    labels[7]="has_excessive_amount_in"
    labels[8]="has_no_effect_on"
    labels[9]="increases_risk_for"
    labels[10]="is_biomarker_for"
    labels[11]="is_contraindicated_for"
    labels[12]="is_deficient_in"
    labels[13]="prevents"
    labels[14]="results_in_side_effect"
    labels[15]="treats"
    labels[16]="used_in_diagnosis_of"
    labels[17]="other"
